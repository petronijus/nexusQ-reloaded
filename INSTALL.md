# Nexus Q Reloaded -- Install Guide (v0.1.0)
...
- release artifacts: `nexusq-boot-v0.1.0.img`, `nexusq-rootfs-v0.1.0-sparse.img`
...
```bash
# Boot image (kernel + DTB) -> 8 MB boot partition
