...
**Bluetooth A2DP**, a beat-reactive **32-LED ring**, an **on-demand Wayland desktop**
you can drive with a **BT mouse&nbsp;+&nbsp;keyboard**, a 1.2&nbsp;GHz CPU,
**NFC tap-to-send**, and a **phone/desktop companion remote** that doubles as the
screenless orb's **Bluetooth settings panel**.
