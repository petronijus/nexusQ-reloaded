...
(dev, post-1.12.0, untagged) ─ ✦ first clean idle-OPP measurement: 60.5 % @ 350 MHz over a 14 h hands-off MQTT window → same-day per-cgroup attribution (63 % of idle busy CPU = short-lived forks; top consumer = our nq-healthd at ~6.3 % of a core) → nq-healthd FORK DIET shipped via OTA (device r71: −60 % healthd CPU, idle fork rate 14→3.2/s, JSONL schema unchanged)   2026-08-13
