...
enum ctl_kind { CTL_THEME, CTL_SET, CTL_MUTE, CTL_OFF, CTL_STATUS, CTL_VOL, CTL_MTOGGLE, CTL_AUTO, CTL_SCENE, CTL_BRIGHTNESS, CTL_BREATHE, CTL_SETMUTED, CTL_SPIN, CTL_PROGRESS, CTL_MBLINK };
